...
export const CardVermes = ({ nameImage, title, idVerme, description, description2 }: CardVermesProps) => {
  const image =
    nameImage === "ANCILOSTOMÍASE"
      ...
      : nameImage === "TENIASE"
      ? require("../../../assets/vermes/TENIASE.jpg")
      : require("../../../assets/vermes/TRICURÍASE.png");
